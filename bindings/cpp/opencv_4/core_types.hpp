...
template struct Result<const unsigned long long>;
...
template struct Result<cv::Ptr<cv::cuda::GpuMat::Allocator>*>;
...
template struct Result<cv::cuda::BufferPool*>;
...
template struct Result<cv::ogl::Arrays*>;
template struct Result<cv::ogl::Buffer*>;
template struct Result<cv::ogl::Texture2D*>;
template struct Result<cv::ogl::Texture2D::Format>;
...
template struct Result<long long>;
