...
extern "C" {
	...
	Result<cv::HOGDescriptor::HistogramNormType> cv_HOGDescriptor_getPropHistogramNormType_const(const cv::HOGDescriptor* instance) {
		try {
			cv::HOGDescriptor::HistogramNormType ret = instance->histogramNormType;
			return Ok<cv::HOGDescriptor::HistogramNormType>(ret);
		} OCVRS_CATCH(OCVRS_TYPE(Result<cv::HOGDescriptor::HistogramNormType>))
	}
	
	Result_void cv_HOGDescriptor_setPropHistogramNormType_HistogramNormType(cv::HOGDescriptor* instance, cv::HOGDescriptor::HistogramNormType val) {
		try {
