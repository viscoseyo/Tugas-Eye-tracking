...
extern "C" {
	...
	Result<cv::AsyncArray*> cv_AsyncArray_AsyncArray_const_AsyncArrayR(const cv::AsyncArray* o) {
		try {
	...
	Result<cv::AsyncPromise*> cv_AsyncPromise_AsyncPromise_const_AsyncPromiseR(const cv::AsyncPromise* o) {
		try {
	...
	Result_void cv_FileNode_setPropBlockIdx_size_t(cv::FileNode* instance, size_t val) {
		try {
	...
	Result<size_t> cv_FileNode_getPropOfs_const(const cv::FileNode* instance) {
		try {
	...
	Result_void cv_FileNode_setPropOfs_size_t(cv::FileNode* instance, size_t val) {
		try {
			instance->ofs = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result<cv::UMatData::MemoryFlag> cv_UMatData_getPropFlags_const(const cv::UMatData* instance) {
		try {
			cv::UMatData::MemoryFlag ret = instance->flags;
			return Ok<cv::UMatData::MemoryFlag>(ret);
		} OCVRS_CATCH(OCVRS_TYPE(Result<cv::UMatData::MemoryFlag>))
	}
	
	Result_void cv_UMatData_setPropFlags_MemoryFlag(cv::UMatData* instance, cv::UMatData::MemoryFlag val) {
		try {
			instance->flags = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result<void*> cv_detail_CheckContext_getPropFunc_const(const cv::detail::CheckContext* instance) {
		try {
	...
	Result<void*> cv_detail_CheckContext_getPropFile_const(const cv::detail::CheckContext* instance) {
		try {
	...
	Result<int> cv_detail_CheckContext_getPropLine_const(const cv::detail::CheckContext* instance) {
		try {
			int ret = instance->line;
			return Ok<int>(ret);
		} OCVRS_CATCH(OCVRS_TYPE(Result<int>))
	...
	Result_void cv_detail_CheckContext_setPropLine_int(cv::detail::CheckContext* instance, int val) {
		try {
			instance->line = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result<cv::detail::TestOp> cv_detail_CheckContext_getPropTestOp_const(const cv::detail::CheckContext* instance) {
		try {
			cv::detail::TestOp ret = instance->testOp;
			return Ok<cv::detail::TestOp>(ret);
		} OCVRS_CATCH(OCVRS_TYPE(Result<cv::detail::TestOp>))
	}
	
	Result_void cv_detail_CheckContext_setPropTestOp_TestOp(cv::detail::CheckContext* instance, cv::detail::TestOp val) {
		try {
			instance->testOp = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result<void*> cv_detail_CheckContext_getPropMessage_const(const cv::detail::CheckContext* instance) {
		try {
	...
	Result<void*> cv_detail_CheckContext_getPropP1_str_const(const cv::detail::CheckContext* instance) {
		try {
	...
	Result<void*> cv_detail_CheckContext_getPropP2_str_const(const cv::detail::CheckContext* instance) {
		try {
	...
	Result<cv::utils::logging::LogLevel> cv_utils_logging_LogTag_getPropLevel_const(const cv::utils::logging::LogTag* instance) {
		try {
	...
	Result_void cv_utils_logging_LogTag_setPropLevel_LogLevel(cv::utils::logging::LogTag* instance, cv::utils::logging::LogLevel val) {
		try {
			instance->level = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
